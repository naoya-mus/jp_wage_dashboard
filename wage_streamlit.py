...
df_jp_ind = pd.read_csv('.\csv_data\産業構造マップ_雇用_一人当たり賃金_全国_全産業.csv', encoding='shift_jis')
df_jp_category = pd.read_csv('.\csv_data\産業構造マップ_雇用_一人当たり賃金_全国_大分類.csv', encoding='shift_jis')
df_pref_ind = pd.read_csv('.\csv_data\産業構造マップ_雇用_一人当たり賃金_都道府県_全産業.csv', encoding='shift_jis')
...
st.header('年齢階級別の全国一人あたりの平均賃金（万円）')
...
st.plotly_chart(fig)
show_df_mean_bubble = st.checkbox('Show DataFrame2')
if show_df_mean_bubble == True:
    st.write(df_mean_bubble)
